      ...
      <div className="relative bg-primary w-full 2xl:h-[445px] xl:h-[400px] lg:h-[360px] md:h-[300px] h-[380px] rounded-[35px] p-[24px] md:p-[35px] flex flex-col items-center">
        ...
        <div className="relative flex flex-col justify-end h-full w-full">
          ...
          <div className="relative z-[4] flex w-full h-full md:h-fit md:flex-row flex-col justify-between items-center">
            {/* Текст */}
            <p className="self-start md:self-center text-white sm:text-[20px] sm:max-w-[420px] max-w-[350px] text-[18px] font-semiBold leading-[120%]">
            ...
            <button
              ...
              className="self-end flex items-center justify-between bg-white border-[1px] rounded-[25px] p-[3px] sm:h-[50px] h-[44px] group"
            >
